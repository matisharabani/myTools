...
public class Bhead_report_main {
	...
	public static void main(String[] args) throws Exception {
		...
		File dir=new File("C:\\TEST_DATA_FILES\\CM");
   ...
   public static void handleFile(File file) {
	   ...
	   //System.out.println("Input File last modified date - Before Format : " + file.lastModified());
	   SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
	   System.out.println(file.getName() + " last modified date: " + sdf.format(file.lastModified()));    
	   fileAge=(System.currentTimeMillis()- file.lastModified())/1000/60/60/24;
	   System.out.println("fileAge: " + fileAge + " days");
	  	  
	   if (fileAge < 100) {
		   createBheadReport(file);		  		  		  
	   }

	   //System.out.println("File was created " + (System.currentTimeMillis()- file.lastModified()) + " miliseconds ago");
	   //System.out.println("File was created " + (System.currentTimeMillis()- file.lastModified())/1000/60/60/24 + " days ago");  	  
   }
   
   public static void createBheadReport(File file) {
